...
insert into funcionarios (nome, cpf, data_nascimento, endereco, telefone, email, cargo, salario, data_admissao)
values					 ('Lívia Castro', '222.333.444-55', '1989-11-25', 'Av. Rebouças 1234, São Paulo', '11987653421', 'livia.castro@email.com', 'Subgerente', 5500.00, '2019-06-20'),
...
insert into clientes (nome, cpf, data_nascimento, endereco, telefone, email, data_cadastro)
values				 ('Ana Paula', '234.567.890-12', '1985-03-22', 'Rua Oscar Freire, 1290, São Paulo', '11987652345', 'ana.paula@email.com', '2023-01-12'),
...
select * from pedidos;
insert into pedidos (id_cliente, id_funcionario, id_produto, quantidade, data_pedido, status_pedido)
